from sqlalchemy import create_engine, Column, Integer, String, UUID, DateTime, func, ForeignKey, Enum, Table
...
class User(Base):
    ...
    favorite_bots: Mapped[list["Bot"]] = relationship("Bot", secondary='users_bots', back_populates="favorite_users")
...
class Bot(Base):
    ...
    favorite_users: Mapped[list['User']] = relationship('User', secondary='users_bots', back_populates="favorite_bots")
